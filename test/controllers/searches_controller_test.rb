...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { status: @search.status, total_results: @search.total_results } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { status: @search.status, total_results: @search.total_results } }
